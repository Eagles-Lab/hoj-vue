  ...
  <div id="app">
    ...
    <div v-if="!isAdminView" class="full-height flex-column">
      ...
      <footer v-if="showFooter" class="fix-to-bottom">
        <div class="mundb-footer" v-if="false">
          <el-row>
            <el-col :md="12" :xs="24">
              <h1 class="footer-title"><i class="el-icon-s-operation"></i> {{ $t('m.Service') }}</h1>
              <p class="footer-link">
                <a @click="goRoute('/status')">{{ $t('m.Judging_Queue') }}</a>
              </p>
            </el-col>
            <el-col :md="12" :xs="24">
              <h1 class="footer-title"><i class="fa fa-life-ring" aria-hidden="true"></i> {{ $t('m.Support') }}</h1>
              <p class="footer-link">
        ...
        <div class="mundb-footer">
          ...
          Powered by <a href="https://www.eagleslab.com" target="_blank" rel="noopener" style="color:#1E9FFF">EaglesLab</a>
